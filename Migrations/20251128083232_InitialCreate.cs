        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Activation_Code = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    User_ID = table.Column<int>(type: "int", nullable: false),
                    Admin_Level = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    User_ID = table.Column<int>(type: "int", nullable: false),
                    Availability_Schedule = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Revoked_By_User_ID = table.Column<int>(type: "int", nullable: true),
                    Granted_At = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Revoked_At = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CarerUser_ID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    User_ID = table.Column<int>(type: "int", nullable: false),
                    Clinician_User_ID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "Authorised carer with access to patient data", "Carer" }
                });
